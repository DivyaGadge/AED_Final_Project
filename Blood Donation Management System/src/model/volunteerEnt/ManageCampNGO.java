    ...
    public void endCamp(int id) {
        try {
            ...
            if (con != null) {
                ...
                String query = "UPDATE Camps SET status = 'closed' WHERE camp_id= "+id+"";
                PreparedStatement pstmt = con.prepareStatement(query);
                
                pstmt.execute();
                
                JOptionPane.showMessageDialog(null, "Camp has been ended successfully.");
